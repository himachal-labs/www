...
export default async function ProcessReceiptPage({ params }: Props) {
  const { id } = await params
  const appStoreUrl = "https://apps.apple.com/app/moneytide/"
  const deepLink = `moneytide://process-receipt/${id}`
  
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md mx-auto text-center p-6">
        <h1 className="text-2xl font-bold mb-4">Receipt Processing</h1>
        <p className="text-gray-600 mb-6">
          Process your receipt in MoneyTide for automatic expense tracking.
        </p>
